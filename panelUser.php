...
<head>
    ...
    <title>DBQ 1.6.8 | Painel Usuário</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="dropdown-menu">
                <li><a href="panelUser.php"><i class="fa fa-fw fa-cog"></i> Painel Usuário</a></li>
                <li class="divider"></li>
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
                ...
                <li>
                    <a href="panelUser.php"><span class="glyphicon glyphicon-home"></span>  Painel Usuário</a>
                </li>
                <li>
        ...
        <div class="container-fluid">
            ...
            <div class="row" id="main">
                <div class="col-sm-12 col-md-12 well" id="content">
                    ...
                    <?php include 'panelUserRegisteredQuestions.php'; ?>
                </div>
            </div>
            <!-- /.row -->
        </div>
