                          ...
                          <table class="table table-bordered table-striped">  
                               ...
                               <tr>  
                                    ...
                                    <td>
                                      ...
                                      <button type="button" name="edit" value="Edit" id="<?php echo $row["idQuestion"]; ?>" class="btn btn-info btn-xs edit_data" ><span class="glyphicon glyphicon-edit"></span></button>
                                      <!--botão para visualizar questão e alternativas-->  
                                      <button type="button" name="view" value="view" id="<?php echo $row["idQuestion"]; ?>" class="btn btn-info btn-xs view_data"><span class="glyphicon glyphicon-list-alt"></span></button>
                                      ...
                                      <span class="badge badge-píll badge-secondary"><?php echo $row["qDiscipline"]; ?></span>
                                    </td>  
                               </tr>  
                               <?php  
                               }  
